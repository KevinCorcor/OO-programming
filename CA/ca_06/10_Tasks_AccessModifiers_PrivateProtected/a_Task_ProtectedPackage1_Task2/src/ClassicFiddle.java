...
public class ClassicFiddle extends PlainFiddle{  // 03: made public for Runner.java
	//default constructor same as class - public
	public void playSweetly(){ // 04 made public for Runner.java
		play();		//attempt access through inheritance has //to be protected or public to work
