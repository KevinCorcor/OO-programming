...
class Runner
{
	public static void main(String[] args){
		...
		System.out.println("**********************************");
		System.out.println("now flys ");
		ducks[0].setFlyDehavior(new FlyWithWings());
		System.out.println("now quacks ");
		ducks[0].setQuackBehacvior(new Quack());

		demonstrateDucks(ducks); //first duck has changed behavior
	}
